...
const char *FLAG_DESC[FLAG_MAX+1] = {
  ...
  /* FLAG_HOMOTOPY_ADAPT_BEND */          "[double (default 0.05)] maximum trajectory bending to accept the homotopy step",
  /* FLAG_HOMOTOPY_H_EPS */               "[double (default 1e-3)] tolerance respecting residuals for the homotopy H-function",
